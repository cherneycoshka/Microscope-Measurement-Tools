...
Reads user settings from `Microscope_Calibrations_user_settings_JPHEdit.py`  
...
# microscope settings should be in the file `Microscope_Calibrations_user_settings_JPHEdit.py`: 
import Microscope_Calibrations_user_settings_JPHEdit as cal      # imports `names`, `cals`, `units` under namespace `cal.names` etc. 
